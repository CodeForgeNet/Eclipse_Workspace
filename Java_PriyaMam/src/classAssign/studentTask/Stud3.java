...
public class Stud3 {
	...
	long mobno;
	int id;
	ScoreCard3 stud3ScoreCard;
	
	public Stud3(String name, long mobno, int id, ScoreCard3 stuScoreCard) {
		this.name=name;
		this.mobno=mobno;
		this.id=id;
		this.stud3ScoreCard=stuScoreCard;
	}
